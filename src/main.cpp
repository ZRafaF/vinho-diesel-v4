...
#define HELPER_INTERRUPT_MODE_OFFLINE RISING

#elif LINE_COLOR == BLACK
#define HELPER_INTERRUPT_MODE RISING
#define HELPER_INTERRUPT_MODE_OFFLINE FALLING
...
PIDestal sensorsPid(1.8, 0.001, 11);
